...
import 'package:appjam_mlkit/pages/translation_result_page.dart';
...
class MLKitTranslationPage extends StatefulWidget {
  MLKitTranslationPage({Key? key}) : super(key: key);
...
class _MyHomePageState extends State<MLKitTranslationPage> {
  ...
  */
  ...
  Future<Translation> cevir(){
    Future<Translation> ceviri = translator.translate(scannedText, from: 'en', to: 'tr');
    return ceviri;
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(onPressed: (){
                      //translateFunction();
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => TranslationResultPage(scannedText: scannedText, fromLanguage: 'en', toLanguage: 'tr')));
